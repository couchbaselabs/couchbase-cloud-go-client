...
const (
	DRAFT V3ClusterStatus = "draft"
	DEPLOYING V3ClusterStatus = "deploying"
	DESTROYING V3ClusterStatus = "destroying"
	HEALTHY V3ClusterStatus = "healthy"
	DEGRADED V3ClusterStatus = "degraded"
)
